...
# -----------------------------------------
# ROUTE: LOGIN link to login.html
# -----------------------------------------
# When a user clicks the login icon to go to login.hmtl/account, it will check if user is logged is
...
def register():
    ...
    if not fullName or not email or not password:
        ...
        return render_template(LOGIN_TEMPLATE, reg_error='Alle felter skal udfyldes')
    ...
    if cursor.fetchone():
        ...
        conn.close()
        return render_template(LOGIN_TEMPLATE, reg_error='Email er allerede i brug')
...
def login():
    ...
    if not email:
        return render_template(LOGIN_TEMPLATE, mail_error='Email er påkrævet')
    ...
    if not row:
        return render_template(LOGIN_TEMPLATE, mail_error='Email ikke fundet')
    ...
    if stored_password == password:
        ...
        return render_template(LOGIN_TEMPLATE, login_error='Forkert kodeord')
